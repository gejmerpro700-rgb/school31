...
import { getFirestore, collection, addDoc, onSnapshot, query, orderBy, limit, serverTimestamp, doc, setDoc, getDocs, deleteDoc } from "https://www.gstatic.com/firebasejs/10.12.5/firebase-firestore.js";
...
// Firestore helpers (so non-module scripts can use them)
window.school31Firebase.fs = {
  collection,
  addDoc,
  onSnapshot,
  query,
